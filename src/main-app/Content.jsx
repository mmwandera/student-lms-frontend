...
export default function Content() {
  return (
    <div>
      ...
      <div>
        <h1 className="text-center text-3xl font-bold mt-10 mb-4">Explore Courses</h1>
        <div className="flex p-10 ">
          <Button variant="ghost">Artificial Intelligence</Button>
          <Button variant="ghost">Computer Science</Button>
          <Button variant="ghost">Engineering</Button>
          <Button variant="ghost">Filming</Button>
          <Button variant="ghost">Fitness</Button>
